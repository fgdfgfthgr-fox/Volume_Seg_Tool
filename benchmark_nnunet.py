...
if __name__ == "__main__":
    ...
    run("nnUNetv2_train 001 3d_fullres 1", custom_env=my_env)
    run("nnUNetv2_train 001 3d_fullres 2", custom_env=my_env)
    run("nnUNetv2_train 001 3d_fullres 3", custom_env=my_env)
    end_time = time.time()
