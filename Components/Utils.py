...
def perform_watershed(segmentation, dynamic):
    ...
    """
    print('Starting distance transformation...')
    ...
    hmin = distance_map + dynamic
    print('Starting Reconstruction...')
    numba_morph.reconstruction(distance_map, hmin, inplace=True, method='erosion', footprint=footprint)
